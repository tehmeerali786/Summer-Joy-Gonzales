...
<div class="container">
	...
	<?php else : ?>
	<header class="page-header">
		<h2 class="page-title"><?php esc_html_e( 'Posts', 'negocio-business' ); ?></h2>
	</header>
	<?php endif; ?>
	...
	<div class="content-area">
		<main id="main" class="site-main" role="main">
			<?php
			    $layout_option = get_theme_mod( 'negocio_business_theme_options',__( 'Right Sidebar','negocio-business') );
								...
								<div class="navigation">
					                <?php
					                    ...
					                    the_posts_pagination( array(
					                        'prev_text'          => __( 'Previous page', 'negocio-business' ),
					                        'next_text'          => __( 'Next page', 'negocio-business' ),
					                        'before_page_number' => '<span class="meta-nav screen-reader-text">' . __( 'Page', 'negocio-business' ) . ' </span>',
					                    ) );
					                ?>
